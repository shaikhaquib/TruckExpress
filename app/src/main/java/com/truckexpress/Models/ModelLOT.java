...
public class ModelLOT implements Serializable {
	...
	public String getCorporateContactPersoneEmail(){
		return corporateContactPersoneEmail;
	}
	...
	public void setShortageallowance(String shortageallowance){
		this.shortageallowance = shortageallowance;
	}

	public String getShortageallowance(){
		return shortageallowance;
	}
	...
	public void setBookingnooftruck(int bookingnooftruck){
		this.bookingnooftruck = bookingnooftruck;
	}

	public int getBookingnooftruck(){
		return bookingnooftruck;
	}
