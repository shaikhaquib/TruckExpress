...
public class ModelUnLoadedTrcukList {
    ...
    @SerializedName("unloadednob")
    private int unloadednob;
    ...
    private double weightunloading;
    ...
    public int getUnloadednob() {
        return unloadednob;
    }

    public void setUnloadednob(int unloadednob) {
        this.unloadednob = unloadednob;
    }
    ...
    public double getWeightunloading() {
        return weightunloading;
    }

    public void setWeightunloading(double weightunloading) {
