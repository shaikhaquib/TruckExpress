...
import static com.truckexpress.Network.API.TripInProcess;
...
public class BookingActivity extends AppCompatActivity {
    ...
    public class CurrentBooking extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (!s.equals("unsuccessful")) {
                ...
                Intent intent = new Intent("TripInProcess");
                sendBroadcast(intent);
