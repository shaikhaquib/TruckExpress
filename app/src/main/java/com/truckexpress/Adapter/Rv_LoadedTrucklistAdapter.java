...
public class Rv_LoadedTrucklistAdapter extends RecyclerView.Adapter<Rv_LoadedTrucklistAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Rv_LoadedTrucklistAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Rv_LoadedTrucklistAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_details, parent, false));
    }
